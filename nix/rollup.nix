...
let
    sov-ibc-hash = "sha256-PZlKt4gXSgAYLr8XHs/2LNsetWPqkn9GvgMzqcsfrao=";
    ...
    rollup-guest-mock = nixpkgs.rustPlatform.buildRustPackage {
        ...
        cargoLock = {
            ...
            outputHashes = {
                ...
                "ibc-app-transfer-0.53.0" = "sha256-6HcMSTcKx4y1hfKcXnzgiNM9FWdqUuUNnemAgS36Z1A=";
            };
        };
    ...
    rollup = nixpkgs.rustPlatform.buildRustPackage {
        ...
        cargoLock = {
            ...
            outputHashes = {
                ...
                "sov-celestia-client-0.1.0" = sov-ibc-hash;
                "ibc-0.53.0" = "sha256-6HcMSTcKx4y1hfKcXnzgiNM9FWdqUuUNnemAgS36Z1A=";
            };
        };
